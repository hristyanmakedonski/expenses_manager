...
require '../Other/Permissions.php';  Permissions::checkPermissions();?>
    <?php if(isset($_SESSION) &&  key_exists('firstname', $_SESSION)):?>
       <div class="hi"><h1> Hi, <?php echo $_SESSION['firstname'];?>, this is all for you! </h1></div>
    <?php endif;?>
        <?php 
        ...
        $result = $infoUser->GetInfo();
          if(isset($_SESSION) &&  key_exists('result', $_SESSION)):?>
       </div>
       <div class="picture">
       ...
       <div class="info"><h2><?php echo $k.' : '.$v ; ?></h2></div>
          <?php endforeach;?>
       </div>
          <?php endif;?>
